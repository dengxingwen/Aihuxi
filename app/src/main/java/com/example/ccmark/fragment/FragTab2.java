...
public class FragTab2 extends Fragment {
    ...
    private static final String TAG = "FragTab2";
...
//        lineChart.setDragDecelerationFrictionCoef(0.99f);//与上面那个属性配合，持续滚动时的速度快慢，[0,1) 0代表立即停止。
    ...
    public void getHistoryData() {
        ...
        HistoryWeekApi historyWeekApi = retrofit.create(HistoryWeekApi.class);
        Call<List<HistoryWeek>> call = historyWeekApi.getHistoryWeekData("北京", Custom.getNowDataMonthStr());
